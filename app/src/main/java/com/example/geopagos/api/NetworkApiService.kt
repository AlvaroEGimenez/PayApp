...
interface NetworkApiService {
    ...
    fun cardIssuers(@Query("public_key")  publicKey: String, @Query("payment_method_id") id: String) : Single<ArrayList<CardIssuers>>

    @GET("payment_methods/installments")
    fun installments(@Query("public_key")  publicKey: String,
                     @Query("amount") amount: String,
                     @Query("payment_method_id") bin: String,
    @Query("issuer.id") issuerId: String) : Single<ArrayList<Installments>>
